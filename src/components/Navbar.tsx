        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="hidden sm:inline-flex px-5 py-2.5 rounded-full bg-gradient-to-r from-neon-blue to-neon-purple text-white text-sm font-semibold hover:shadow-lg hover:shadow-neon-blue/25 transition-shadow cursor-pointer"
            >
              Start Growing
            </motion.a>
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-surface-border">
                <a
                  ...
                  className="block w-full text-center px-5 py-3 rounded-full bg-gradient-to-r from-neon-blue to-neon-purple text-white text-sm font-semibold cursor-pointer"
                >
                  Start Growing
                </a>
              </div>
